...
test("correct task should be added to correct array", () => {
  ...
  }, "requestId", {title:"juse", todolistId: "todolistId2"}, " ");
...
test("title of specified task should be changed", () => {
  const action = tasksThunks.updateTask.fulfilled(
      { taskId: "2", domainModel: { title: "yogurt" }, todolistId: "todolistId2" }, "requestId",
...
test("propertry with todolistId should be deleted", () => {
  const action = todolistThunk.removeTodolist.fulfilled({ id: "todolistId2" }, "", {id: ""}, " ");
